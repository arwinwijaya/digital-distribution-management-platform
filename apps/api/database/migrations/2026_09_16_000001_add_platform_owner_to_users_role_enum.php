...
{
    private const WITH_PLATFORM_OWNER = ['admin', 'supplier', 'outlet', 'sales', 'driver', 'finance', 'platform_owner'];
    private const WITHOUT_PLATFORM_OWNER = ['admin', 'supplier', 'outlet', 'sales', 'driver', 'finance'];

    public function up(): void
    {
        $this->replaceRoleConstraint(self::WITH_PLATFORM_OWNER);
    }

    public function down(): void
    {
        DB::table('users')->where('role', 'platform_owner')->update(['role' => 'outlet']);
        $this->replaceRoleConstraint(self::WITHOUT_PLATFORM_OWNER);
    }
