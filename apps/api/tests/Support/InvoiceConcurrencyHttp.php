...
/** Runs the real concurrent PostgreSQL HTTP workers behind the approval barrier. */
final class InvoiceConcurrencyHttp
{
    ...
    public function start(): void
    {
        ...
        foreach (['A', 'B'] as $participant) {
            ...
            $environment = $this->environment($participant);
