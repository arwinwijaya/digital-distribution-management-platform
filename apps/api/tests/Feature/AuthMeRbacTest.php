...
/**
 * GET /auth/me must include a full 19-key `rbac` map for the caller's role.
 */
class AuthMeRbacTest extends TestCase
{
    ...
    public function test_me_includes_nineteen_key_rbac_map(): void
    {
